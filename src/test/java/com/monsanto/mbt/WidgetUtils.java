...
public class WidgetUtils {
    ...
    /**
     * mocks the sample widgets
     *
     * @return - mocked list of widgets
     */
    ...
    /**
     * converts string to date of a specific format
     * @param strDate
     * @return
     */
    public static Date stringToDateConverter(String strDate){
        Date parsedDate = null;
        SimpleDateFormat formatter = new SimpleDateFormat(MbtConstants.MM_DD_YYYY_FORMAT);
        try {
